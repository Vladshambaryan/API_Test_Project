...
@allure.title('Обновление мема - неавторизованный пользователь')
...
@allure.title('Обновить мем - запрещено другому пользователю')
...
@allure.title('Обновление мема - отрицательные тесты')
...
@allure.title('Получить один мем - неавторизованный пользователь')
...
@allure.title('Получить все мемы - неавторизованный пользователь')
...
@allure.title('Удаление мема - неавторизованный пользователь')
...
@allure.title('Удалить мемa - запрещено другому пользователю')
